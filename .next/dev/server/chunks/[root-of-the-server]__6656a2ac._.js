...
async function GET(req) {
    try {
        ...
        const hasGlobalQuerySignals = searchParams.has("search") || searchParams.has("limit") || searchParams.has("offset") || searchParams.has("type");
        ...
        if (mine || !hasGlobalQuerySignals) {
            ...
            let query = supabase.from("reports").select("*").eq("user_id", user.id).order("created_at", {
                ascending: false
            });
            if (status) {
        ...
        if (status && Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ReportStatus"]).includes(status)) {
            query = query.eq("status", status);
        }
        if (type && Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ReportType"]).includes(type)) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6656a2ac._.js.map