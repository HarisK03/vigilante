...
function IconSquare(props: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={props.className} fill="none">
      <path d="M6 6h12v12H6z" stroke="currentColor" strokeWidth="2" opacity="0.95" />
    </svg>
  );
}
...
function IconReports(props: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={props.className} fill="none">
      ...
      <path d="M8 12h8M8 16h8" stroke="currentColor" strokeWidth="2" opacity="0.9" />
    </svg>
  );
}
...
function IconIncidents(props: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={props.className} fill="none">
      <path d="M12 2 3 20h18L12 2z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
...
function IconResources(props: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={props.className} fill="none">
      ...
      <path d="M12 11v10" stroke="currentColor" strokeWidth="2" opacity="0.9" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 24 24" className={props.className} fill="none">
      <path
        ...
        strokeWidth="2"
      />
      <path d="M8 9h8M8 13h5" stroke="currentColor" strokeWidth="2" opacity="0.9" />
      <path
